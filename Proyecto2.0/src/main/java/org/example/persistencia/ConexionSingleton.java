...
public class ConexionSingleton {
    ...
    private ConexionSingleton(String database) {
        ...
        try {
            ...
            String dbUrl = "jdbc:sqlite::resource:" + this.baseDatos;
            connection = DriverManager.getConnection("jdbc:sqlite:file:D:/df/final/Proyecto2.0/src/main/resources/instrumentos.db");
